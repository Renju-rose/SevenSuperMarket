...
public class WaitUtility 
{
   ...
   public static void waitForElementIsPresent(WebDriver driver, By target) 
   {
	...
	public static void waitForInvisibilityOfElementText(WebDriver driver, By target) 
	{
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(EXPLICIT_WAIT));
		wait.until(ExpectedConditions.invisibilityOfElementWithText(target,null));
	}
    ...
    public static void fluentWaitForElements(WebDriver driver,By target)
    {
